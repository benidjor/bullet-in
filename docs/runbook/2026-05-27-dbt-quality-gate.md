...
> 이 문서는 게이트의 최초 구성을 적은 것이다.
> 지금은 모델 8개 · 테스트 21종이고 회차 끝에서 자동으로 돌며 실패하면 배포를 막는다.
> 현재 동작과 차단 대응은 `docs/superpowers/specs/2026-08-31-dbt-quality-gate-design.md` ·
> `docs/runbook/2026-08-31-when-the-dbt-gate-blocks-a-deploy.md` 를 본다.
