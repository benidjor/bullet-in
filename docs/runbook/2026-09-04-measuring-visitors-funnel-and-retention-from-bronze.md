...
**이 셋은 날짜를 거르지 않고 표 전체를 센 값이다** (공개 전인 08-24 · 08-28 이 섞여 있다).
공개 주간 (08-29 부터 09-04) 의 순 사용자는 **827** 이고
([공개 주간 순 사용자 890 은 표 전체 값이었다](../troubleshooting/2026-09-19-the-launch-week-number-was-the-whole-table.md)),
세션과 참여 세션 비율은 날짜를 걸러 다시 세지 않았다.

![GA4 보고서 개요 (공개 주간)](../assets/ga4-users-launch-week.png)

> GA4 보고서 개요에서 2026-08-29 부터 09-04 까지를 본 화면이다 (2026-09-18 캡처 · 계정 · 프로젝트 식별자는 가렸다).
> 활성 사용자 822명 · 신규 사용자 812명이고, 신규 대 재방문 그래프의 08-29 급등이 공개일이다.
> 같은 7일을 GA4 는 총 사용자 827명으로 세고 행동 지표 대시보드의 「Users · 7일」 도 827명이다.
...
| 값 | 수 |
| --- | --- |
| 사용자 7일 · 세션 · 참여 세션 비율 | 890 · 1,502 · 61% (날짜 미필터 · 공개 주간 사용자는 827 · §3) |
| 공개일 DAU · 신규 | 688 · 666 |
| 퍼널 | 863 → 221 → 97 → 71 |
