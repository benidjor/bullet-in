...
- **쓰이지 않는 기사 페이지 정리 (신규 후보, 2026-07-20)** — 재수집 · 삭제로 DB 에서 빠진 기사의 페이지 파일이 `site/article/` 에 그대로 남아 누적.
  - 실측 (2026-07-20 표기 백필 검증 중 발견): 파일 379개 vs DB 205행 — 차이 174건이 쓰이지 않는 페이지.
