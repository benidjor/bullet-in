...
**정정 (2026-09-21).**
위의 890명은 §3 의 확인 코드가 날짜 조건 없이 센 값이라 표 전체의 순 사용자였다.
같은 7일 (08-29 부터 09-04) 을 날짜로 걸러 세면 순 사용자는 827명이고, 공개일 688명은 그 83% 다.
경위와 네 출처의 대조는 `docs/troubleshooting/2026-09-19-the-launch-week-number-was-the-whole-table.md` 에 있다.
