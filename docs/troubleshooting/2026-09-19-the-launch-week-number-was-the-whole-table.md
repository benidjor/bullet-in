# 공개 주간 순 사용자 890 은 표 전체 값이었고 827 은 두 달째 캡처에 찍혀 있었다 (2026-09-19)

- **영역**: 행동 로그 / README · 소개 자료의 수치 / VM 자격
...
README 와 소개 자료는 같은 7일을 「순 사용자 890명 (하한선)」 이라고 적어 두었다.
...
| GA4 보고서 총 사용자 | 827 | | |
| 행동 지표 대시보드 「Users · 7일」 (09-06 캡처 · 소개 자료 19장에 실려 있었다) | 827 | | |
...
- 소개 자료 19장의 「890명」 · 「77%」 와 09-04 트러블슈팅 §5 의 「7일 사용자 890명」 은 사용자가 정한다.
- 방문자 수를 적을 때는 창 (날짜 범위) 을 붙인다.

## 5. 배운 것

- **확정값이라도 출처가 문서 하나면 화면 · 외부 도구와 한 번은 대 본다.**
  827 은 소개 자료의 캡처 안에 두 달 동안 찍혀 있었다.
