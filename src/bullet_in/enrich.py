...
TRANSLATE_PROMPT = (
    ...
    "자리를 메우는 replacement 에만 쓴다 — 팀에 남아 있는 주전의 로테이션 자원을 "
    "「대체자」 라 하면 그 선수를 팔고 갈아치운다는 뜻으로 읽힌다.\n"
...
TWEET_PROMPT = (
    ...
    "- 원문이 문장 중간이나 따옴표가 열린 채로 끊겨 있으면 끊긴 자리까지만 옮긴다. "
    "뒷말을 지어내 문장을 완성하지 않는다 — 끝맺음이 어색해도 그대로 둔다.\n"
    "- body_ko 지문은 신문 평어체(종결어미 '~다'): '관심을 갖고 있습니다' ❌ → "
